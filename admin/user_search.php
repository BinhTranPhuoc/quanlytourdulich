                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-8">
                            <h1 class="page-header">USER
                                <small>Danh sách đặt vé</small>
                            </h1>
                        </div>
                        <div class="col-lg-4">
                            <form action="user_search.php" method="POST">
                                <div class="input-group" style="margin-top: 50px;"> 
                                    <input type="text" name="key_search" class="form-control" placeholder="Nhập id user cần tìm...">
                    ...
                    <?php  
                        ...
                        echo '<thead>
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $query = mysql_query("select * from book_tour where id_user = '$key_search'", $connect);
                                ...
                                if ($query) {
                                    echo '<tbody>
                                            <tr class="odd gradeX" align="center">
                                                ...
                                                <td>'.$row['request'].'</td>
                                                <td>'.$row['id_tour'].'</td>
                                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="user_delete.php?id_user='.$row['id_user'].'"> Xóa</a></td>
                                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="user_edit.php?id_user='.$row['id_user'].'"> Sửa</a></td>
                                            </tr>
                                        </tbody>';
                                }
                            }
