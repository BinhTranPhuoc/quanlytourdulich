<?php  
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($id != "" && $image != "" && $title != "" && $journey != "" && $start_time != "" && $price != "" && $content != "" && $slide_thumb != "" && $post_at != "" && $new_price != "" && $apply_for != "") {

            $query = mysql_query("INSERT INTO tour (id, image, title, journey, start_time, price, content, slide_thumb, post_at, new_price, apply_for) VALUES ('$id', '$image', '$title', '$journey', '$start_time', '$price', '$content', '$slide_thumb', '$post_at', '$new_price', '$apply_for')", $connect);
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="/webproject/login.php"><i class="fa fa-sign-out fa-fw"></i> Đăng xuất</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="row">
                    ...
                    <?php 
                        if ($id == "" || $image == "" || $title == "" || $journey == "" || $start_time == "" || $price == "" || $content == "" || $slide_thumb == "" || $post_at == "" || $new_price == "" || $apply_for == "") {
                            ...
                            echo '<font color="#FF0000">Vui lòng điền đầy đủ thông tin</font>';
                        }
                    ?>
                </div>
                <!-- /.row -->
